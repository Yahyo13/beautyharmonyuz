...
export const brands = [
  ...
  },
  {
    ...
    country: "Украина",
    manufacturer: "Elfa Group",
    established: "мужская линия Elfa Group",
    market: "мужской уход 3 в 1",
    sourceNote: "линейка строится вокруг быстрого мужского ухода: душ, волосы, тело, свежесть и энергия",
    ...
    detail:
      "Позиционирование построено на темной упаковке, свежих мужских ароматах и понятной функции 3 в 1. Один флакон работает как шампунь и гель для душа, а серии различаются настроением: мягкое очищение, охлаждающая свежесть и бодрящий уход.",
    buyerText:
    ...
    stats: [
      ["3 в 1", "душ, волосы, тело"],
      ["fresh", "ощущение свежести"],
      ["daily", "ежедневный уход"],
    ],
    facts: [
    ...
    timeline: [
      ["линейка", "мужской уход Elfa Group для душа, волос и тела"],
      ["ассортимент", "форматы 3 в 1 с акцентом на свежесть и энергию"],
      ["витрина", "понятная мужская категория для ежедневного ухода"],
    ],
    source: "https://elfagroup.com/",
  },
  {
    slug: "pink-elephant",
    name: "Pink Elephant",
    ...
    country: "Украина",
    manufacturer: "Elfa Group",
    established: "детская линия Elfa Group",
    market: "детский уход для семейной полки",
    sourceNote: "линейка объединяет мягкое купание, уход за волосами, зубные пасты и защиту губ",
    ...
    detail:
      "Линейка Pink Elephant сделана для мягкого детского ухода: шампуни бережно очищают волосы и кожу головы, пены превращают купание в спокойный ритуал, зубные пасты помогают ежедневной гигиене, а гигиенические помады защищают губы от солнца, ветра и холода.",
    buyerText:
    ...
    stats: [
      ["Kids", "детская линейка"],
      ["Soft", "мягкий уход"],
      ["Family", "для семейной полки"],
    ],
    facts: [
    ...
    timeline: [
      ["линейка", "детская косметика для ежедневного ухода"],
      ["уход", "шампуни, купание, зубные пасты и защита губ"],
...
const brandTranslations = {
  uz: {
    ...
    "cool-men": {
      country: "Ukraina",
      manufacturer: "Elfa Group",
      established: "Elfa Group erkaklar liniyasi",
      market: "3 in 1 erkaklar parvarishi",
      sourceNote: "liniya tez erkaklar parvarishiga qurilgan: dush, soch, tana, tetiklik va energiya",
      ...
      detail: "Pozitsiyalash qora qadoq, tetik erkakcha aromatlar va tushunarli 3 in 1 vazifasiga qurilgan. Bitta flakon shampun va dush geli sifatida ishlaydi, seriyalar esa yumshoq tozalash, sovituvchi tetiklik va energiya kayfiyati bilan farqlanadi.",
      buyerText: "Erkaklar tovarlari polkasi uchun mos: qora qadoq, 3 in 1 vazifasi, tetiklik, energiya va tozalik hissi.",
      stats: [["3 in 1", "dush, soch, tana"], ["fresh", "tetiklik hissi"], ["daily", "kundalik parvarish"]],
      ...
      timeline: [["liniya", "Elfa Group erkaklar parvarishi: dush, soch va tana"], ["assortiment", "tetiklik va energiyaga urg'u berilgan 3 in 1 formatlar"], ["vitrina", "kundalik parvarish uchun tushunarli erkaklar kategoriyasi"]],
    },
    "pink-elephant": {
      country: "Ukraina",
      manufacturer: "Elfa Group",
      established: "Elfa Group bolalar liniyasi",
      market: "oilaviy polka uchun bolalar parvarishi",
      sourceNote: "liniya yumshoq cho'milish, soch parvarishi, tish pastalari va lab himoyasini birlashtiradi",
      ...
      detail: "Pink Elephant yumshoq bolalar parvarishi uchun yaratilgan: shampunlar soch va bosh terisini ehtiyotkor tozalaydi, cho'milish ko'piklari sokin ritual yaratadi, tish pastalari kundalik gigiyenaga yordam beradi, lab bo'yoqlari esa lablarni quyosh, shamol va sovuqdan himoya qiladi.",
      buyerText: "Oilaviy polka uchun qulay brend: mahsulot vazifasi va yumshoq bolalar parvarishi xaridorga darhol tushunarli.",
      stats: [["Kids", "bolalar liniyasi"], ["Soft", "yumshoq parvarish"], ["Family", "oilaviy polka uchun"]],
      ...
      timeline: [["liniya", "kundalik parvarish uchun bolalar kosmetikasi"], ["parvarish", "shampunlar, cho'milish, tish pastalari va lab himoyasi"], ["vitrina", "mayin vizual uslub va tushunarli oilaviy kategoriya"]],
    },
  },
};
...
export const sources = [
  ...
  ["Cool Men", "https://elfagroup.com/"],
  ["Pink Elephant", "https://elfagroup.com/"],
];
