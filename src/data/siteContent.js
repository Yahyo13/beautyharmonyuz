...
export const ui = {
  ru: {
    ...
    auth: {
      ...
      oldUserText: "Вы вошли в профиль. Избранное и корзина будут сохраняться за вашим номером.",
      signedInAs: "Вы вошли как",
      authUnavailable: "Firebase Auth не настроен. Добавьте Firebase-переменные и включите вход по телефону.",
  ...
  uz: {
    ...
    auth: {
      ...
      oldUserText: "Profilga kirdingiz. Saralanganlar va savat raqamingizga saqlanadi.",
      signedInAs: "Siz kirdingiz",
      authUnavailable: "Firebase Auth sozlanmagan. Firebase o'zgaruvchilarini qo'shing va telefon orqali kirishni yoqing.",
