...
export function normalizeCatalogProduct(product, index = 0) {
  ...
  return {
    ...
    description: product.description || product.descriptionRu || localProduct?.descriptionRu || "",
    descriptionRu: product.descriptionRu || product.description || localProduct?.descriptionRu || "",
    descriptionUz: product.descriptionUz || localProduct?.descriptionUz || "",
